...
data class TwitchConfig(
    val enableTwitchIntegration: Boolean = false, val credentials: TwitchCredentials = TwitchCredentials(),
    
    val cakes: Cakes = Cakes(), val poops: Poops = Poops(), val chickenRaid: ChickenRaid = ChickenRaid(), val itemSound: ItemSound = ItemSound(),
    
    val followBorderConfig: FollowBorderConfig = FollowBorderConfig(), val subBorderConfig: SubBorderConfig = SubBorderConfig(), val bitsBorderConfig: BitsBorderConfig = BitsBorderConfig()
)